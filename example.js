...
// privateBitstamp.buyMarket('btcusd', amount).then(function(result) { console.log(result) });
// privateBitstamp.sell('btcusd', amount, price, limit_price).then(function(result) { console.log(result) });
// privateBitstamp.sellMarket('btcusd', amount).then(function(result) { console.log(result) });
